...
const Footer = (
  <footer className="blockquote-footer container-fluid">
    ...
    Страница проекта <a target="_blank" href="https://github.com/ivangolubykh/mmvb_accounting_backend">тут</a>,
    Лицензия: <a target="_blank" href="https://github.com/ivangolubykh/mmvb_accounting_frontend/blob/master/LICENSE">GNU GPL v3.0</a>.
  </footer>
)
